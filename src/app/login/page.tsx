          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-full bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] focus:border-[#3B82F6] focus:bg-[rgba(255,255,255,0.06)] focus:outline-none transition-all text-sm text-white font-medium"
                placeholder="••••••••"
                required
              />
            </div>
